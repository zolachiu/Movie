...
class MovieDetailViewController: UIViewController {
    var movieDetailData = Record(id: "",fields: .init(genre: [], name: "", imdb: 0.0, image: [.init(url: "")], releaseDate: "", rank: 0))
    ...
    override func viewDidLoad() {
        ...
        releasedate.text = movieDetailData.fields.releaseDate
    ...
    @IBAction func editItem(_ sender: UIBarButtonItem) {
        ...
        alert.addTextField{ [self] (textField) in
            ...
            textField.keyboardType = UIKeyboardType.default
            movieDetailData.fields.releaseDate = textField.text!
...
//)))])
            ...
            let movieBody = MovieBody(records: [.init(fields: .init(name:  movieDetailData.fields.name, imdb: movieDetailData.fields.imdb, releaseDate: formatter.date(from: (movieDetailData.fields.releaseDate))!, genre: movieDetailData.fields.genre, image: [.init(url: URL(string: movieDetailData.fields.image[0].url)!)],rank: movieDetailData.fields.rank))])
